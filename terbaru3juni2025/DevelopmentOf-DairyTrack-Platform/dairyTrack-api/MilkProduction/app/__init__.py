...
def create_app():
    ...
    # Enable CORS (HARUS diindentasikan ke dalam create_app)
    CORS(app, resources={r"/*": {"origins": ["http://localhost:3000", "http://localhost:51640"]}})

    # Inisialisasi Socket.IO
    socketio = init_socketio(app)

    # Inisialisasi Background Scheduler untuk pengecekan susu
    global scheduler
    ...
    # Scheduler shutdown saat aplikasi ditutup
